...
(function(Frogger) {
    ...
    function renderScore() {
        ...
        Frogger.drawingSurface.fillStyle = "#FFFFFF";
        Frogger.drawingSurface.fillText("SCORE", _gameBoard.columns[3], _gameBoard.grid.height / 1.5);

        Frogger.drawingSurface.fillStyle = "#FFFF00";
        Frogger.drawingSurface.fillText(_score, _gameBoard.columns[3], _gameBoard.grid.height/0.7);

        Frogger.drawingSurface.fillStyle = "#FFFFFF";
        Frogger.drawingSurface.fillText("HI-SCORE", _gameBoard.columns[8], _gameBoard.grid.height / 1.5);

        Frogger.drawingSurface.fillStyle = "#FFFF00";
        Frogger.drawingSurface.fillText(_highScore, _gameBoard.columns[8], _gameBoard.grid.height/0.7);
    }
    ...
    function renderGameWon() {
        ...
        Frogger.drawingSurface.fillText("YOU WIN! <3", Frogger.drawingSurfaceWidth / 2, _gameBoard.rows[9]);
    }
    ...
    function renderTimeLabel() {
        ...
        Frogger.drawingSurface.font = _font;
        Frogger.drawingSurface.textAlign = "end";
        Frogger.drawingSurface.fillStyle = "#00FFFF";
...
(function(Frogger) {
    ...
    Life.prototype.width = 50;
    Life.prototype.height = 30;
    ...
    function initialize(gameBoard) {
        ...
        _rows = [
            ...
            new Frogger.Row.Log({
                ...
                direction: Frogger.direction.LEFT,
                speed: 6,
